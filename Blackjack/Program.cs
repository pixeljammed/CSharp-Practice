...
class Program
{
    ...
    static void DisplayStats()
    {
        ...
        if (balance < 100)
        {
            Console.WriteLine("YOU LOST ALL YOUR MONEY!!! Next time stick to counter-strike cases eh?");
        }
        ...
        Console.WriteLine($"Win/Loss Ratio: {wins / games}");
